...
<head>
     <meta charset="UTF-8"/>
     <title> Catégories: Immobilier </title>
...
<aside>
  <ul class="catégories">
    ...
    <li class="catégories"><a class="actuel" class="catégories"href="immobiliers.php"><img class="catégories" src="../icons&photos/immobiliers.png"/> Immobilier</a></li>
      ...
      <li class="catégories"><a  class="catégories"href="vihécules.php"><img class="catégories"src="../icons&photos/véhicules.png"/> Véhicules</a></li>
...
<!--    un main contient les annonces déja déposées: extraites d'une base de donnée qui est simuléé  par des fichiers textes   -->
  ...
  <h2 class="immobiliers"> Immobilier </h2>
  <table class="catégories">
    <!-- extraire les information de la base de donée simulé par des fichiers texte      -->
<?php
$immobiliers=fopen('immobiliers.txt','r');
while(feof($immobiliers)==false)
{
  ?>
    <tr class="catégories">
      <?php
  $ligne=fgets($immobiliers);
  $mot="";
  $j=0;
  $length=strlen($ligne);
  for($i=0;$i<$length;$i++)
  ...
  <!--   affichage des informations extraites    -->
    <td class="img"><br>
      <img  src="<?php  echo "$colonne[7]";?>" class="img" /><br>
        </td>
        <td class="description">
          <p class="description"> <span class="immobiliers"> WILAYA :</span> <?php echo "$colonne[0]";?>.</p>
            <p class="description"> <span class="immobiliers"> DAÏRA :</span> <?php echo "$colonne[1]";?>.</p>
              <p class="description"> <span class="immobiliers"> SURFACE :</span> <?php echo "$colonne[2]";?><span class="immobiliers"> m<sup>2</sup></span>.</p>
                <p class="description"> <span class="immobiliers"> ACTE :</span> <?php echo "$colonne[3]";?>.</p>
                  <p class="description"> <span class="immobiliers"> RDC + </span> <?php echo "$colonne[4]";?>.</p>
                    <p class="description"> <span class="immobiliers"> PRIX :</span> <?php echo "$colonne[5]";?><span class="immobiliers"> DA</span>.</p>
                    <p class="description"> <span class="immobiliers"> NUMERO DE TELEPHONE :</span> <?php echo "$colonne[6]";?>.</p>
          </td>
            </tr>
        <?php
}
$closed=fclose($immobiliers);
?>
  </table>
<br>
  </main>
