...
<head>
     <meta charset="UTF-8"/>
     <title> Catégories: Voyages </title>
...
<aside>
  <ul class="catégories">
    ...
    <li class="catégories"><a class="actuel" class="catégories"href="voyages.php"><img  class="catégories"src="../icons&photos/voyages.png"/> Voyages</a></li>
  </ul>
</aside>
...
while(feof($voyages)==false)
{
  ...
  <!--   affichage des informations extraites    -->
    <td class="img"><br>
      <img  src="<?php  echo "$colonne[6]";?>" class="img" /><br>
        </td>
        <td class="description">
          <p class="description"> <span class="voyages"> PAYS :</span> <?php echo "$colonne[0]";?>.</p>
            <p class="description"> <span class="voyages"> VILLE :</span> <?php echo "$colonne[1]";?>.</p>
              <p class="description"> <span class="voyages"> HOTEL :</span> <?php echo "$colonne[2]";?><span class="voyages"> etoiles</span>.</p>
                <p class="description"> <span class="voyages"> DUREE :</span> <?php echo "$colonne[3]";?><span class="voyages"> jours</span>.</p>
                    <p class="description"> <span class="voyages"> PRIX :</span> <?php echo "$colonne[4]";?><span class="voyages"> DA</span>.</p>
                    <p class="description"> <span class="voyages"> NUMERO DE TELEPHONE :</span> <?php echo "$colonne[5]";?>.</p>

          </td>
            </tr>
        <?php
}
$closed=fclose($voyages);
?>
  </table>
<br>
  </main>
