...
<head>
     <meta charset="UTF-8"/>
     <title> Déposer annonce: Véhicules </title>
...
<br><br>
  ...
  <br>
  <!--   le formulaire de déposement d'une annonce vihécule:
    après qu'il soit controlé ces informations seront envoyer par la méthode POST vers le fichier  de traitement php    -->

<form class="déposeruneannonce" method="post" name="add" action="traitementdesformulaires/vihécules.php" enctype="multipart/form-data">
<h2 class="vihécules">Déposer une annonce: Véhicules </h2>
    ...
    <select class="déposeruneannonce" name="marque" id="marque">
      ...
      <option> hyandai</option>
      <option> toyota</option>
    </select>
  <label class="déposeruneannonce" for="modèle"> Modèle: </label>
  <input class="déposeruneannonce" id="modèle" name="modèle"/><br>
  <label class="déposeruneannonce" for="year"> Année de mise en circulation: </label>
  <select class="déposeruneannonce" name="year" id="year">
    <option> 2020 </option>
    <option> 2019 </option>
    <option> 2018 </option>
    <option> 2017 </option>
...
<br>
  <input class="déposeruneannoncevalidationv" type="button" value="valider" onClick="controler(add)"/>
<br><br>
</form>
<br>
  </main>
